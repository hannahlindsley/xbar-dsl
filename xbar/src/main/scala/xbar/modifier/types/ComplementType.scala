...
object ComplementType {
  ...
  final case class NComplement[X : Phrase : CanComplementN](x: Option[X]) extends ComplementType

  final case class VComplement[X : Phrase : CanComplementV](x: Option[X]) extends ComplementType
  ...
  final case class RComplement[X : Phrase : CanComplementR](x: Option[X]) extends ComplementType

  final case class TComplement[X : Phrase : CanComplementT](x: X) extends ComplementType

  final case class JComplement[X : Phrase : CanComplementJ](x: Option[X]) extends ComplementType
